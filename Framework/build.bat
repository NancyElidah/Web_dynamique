set PATH_FRAM="V:\Fianarana\L2\S4\Mr Naina\Projet\backup Fram\sprint13\Framework"
set JAR="V:\Fianarana\L2\S4\Mr Naina\Projet\backup Fram\sprint13\framework.jar"
set V="V:\framework.jar"
set SRC="V:\Fianarana\L2\S4\Mr Naina\Projet\backup Fram\sprint13"
set PATH_TEST="V:\Fianarana\L2\S4\Mr Naina\Projet\backup Fram\sprint13\testFramework"
...
@REM copier .jar dans le dossier sprint13
...
cd ../
@REM redirection vers le dossier sprint13 
cd %SRC%
